    ...
    public class Function
    {
        ...
        public async Task FunctionHandler(S3Event evnt, ILambdaContext context)
        {
            ...
            try
            {
                ...
                if (s3Event.Object.Key.Contains("attr"))
                {
                    Console.WriteLine("attribution data");
                     FileManager.AttrToParquet(reader, s3Event.Object.Key);
                }
                else
                {
                    Console.WriteLine("event data");
                    FileManager.EventToParquet(reader, s3Event.Object.Key);
                }
